    ...
    <div className={s.birthdateInfo}>
      ...
      {moonPhase ? (
        <>
          ...
          <p className={s.birthdateDesc}>
            Or perhaps it’s simply not the right time. Other people may find you
            frustrating if you lecture them and talk down to them in a
            patronizing way. No matter how good your intentions are, you can
            come off as arrogant and condescending, like you’re always placing
            yourself in a position of superiority. Learning when to talk, and
            when to let others talk, is the core challenge that you have to
            overcome on the path to self-actualization.
          </p>
        </>
      ) : null}
    </div>
